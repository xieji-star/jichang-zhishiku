...
#   （2026-08-29 起：两个智能助手已移入 总结好的大纲以及笔记/技能/AI/智能助手的配置/，
#   其 config.json 含 API 密钥、logs/wecom-resources/积昌 为运行态，一律排除，防密钥泄露）
# ============================================================
set -u
...
ROBO_EXTRA = {
    ...
    "总结好的大纲以及笔记": ["/XD",
        ...
        "技能/AI/智能助手的配置/飞书智能助手/飞书智能助手/logs",
        "技能/AI/智能助手的配置/飞书智能助手/飞书智能助手/积昌",
    ],
}
CLEANUP = {
    ".claudian": ["sessions"],
    "总结好的大纲以及笔记": [
        ...
        "技能/AI/智能助手的配置/企业微信智能助手/微信智能助手/config.json",
        "技能/AI/智能助手的配置/企业微信智能助手/微信智能助手/logs",
        "技能/AI/智能助手的配置/企业微信智能助手/微信智能助手/wecom-resources",
        "技能/AI/智能助手的配置/企业微信智能助手/微信智能助手/current-tunnel-url.txt",
        "技能/AI/智能助手的配置/企业微信智能助手/微信智能助手/server_pid.txt",
        "技能/AI/智能助手的配置/飞书智能助手/飞书智能助手/config.json",
        "技能/AI/智能助手的配置/飞书智能助手/飞书智能助手/logs",
        "技能/AI/智能助手的配置/飞书智能助手/飞书智能助手/admin_state.json",
        "技能/AI/智能助手的配置/飞书智能助手/飞书智能助手/积昌",
    ],
