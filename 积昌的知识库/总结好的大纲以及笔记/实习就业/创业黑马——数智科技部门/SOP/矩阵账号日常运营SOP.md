...
> [!summary] 概要
> 本文档是图灵学术矩阵账号「华哥系列」的**日常运营标准操作流程（SOP）**。核心定位：本岗位处于业务线上游引流获客阶段，从脚本创作到内容制作再到发布运营**全流程独立完成**。文档涵盖三大主流程（视频制作与发布、图文制作与发布、发布后运营）、辅助流程（内部客单转化登记）、每日工作量基准、工具平台速查、21 条注意事项与办公环境使用指南。**最新变化**：2026-07-30 升级全流程独立运作；2026-08-04 脚本查重与去同质化红线、视频结构表单规范、矩阵账号方向规划；2026-08-06 选题不脱题红线；2026-08-20 私信话术分类逻辑更新（垂直急需/刚需两类打法）+ 特殊情况处理（信任建立但不愿留联系方式→同步韩玲，勿追问）+ 粉丝群运营重构（新成员进群/定期重复发送）+ 粉丝群人满扩容方案（新建群聊/200人小群可扩500人中群/1K大群难达成）+ 脚本创作理念迭代（答案不唯一/爆款有骨架/AI同质化需人工修改/模仿一周内爆款/脚本8分剪辑2分）。**2026-09-09 补充**：新增 [[#十一、飞书群运营规范补充（2026-09-09 整理）|第十一章「飞书群运营规范补充」]]——整理自「三人小分队」群 7.27—8.28 的指令与话术沉淀：公众号文章转口播网页 SOP、长图文排版规范、avatarv4 自动剪辑工具、日报/周报双制度模板、线索三要素与加急标记、私信开场白 A/B、大号洗稿激活与结尾钩子轻量化、数字人 TTS 补充规范、配图信任杠杆等。
...
- 🧩 [[#十一、飞书群运营规范补充（2026-09-09 整理）]] — 转口播网页 SOP / 长图文排版 / avatarv4 自动剪辑 / 日报周报双制度 / 加急标记 / 开场白 A/B / 大号洗稿激活 / TTS 补充
...
- **查重与去同质化红线（2026-08-04）**：
  - ⚠️ 上周五一条视频播放 1万+ 后**被抖音官方以"内容重复"<span style="color:#e74c3c">贴标签限流</span>**——高播放不保险，内容原创性是硬指标（抖音"重复度过高"的判定标准与处罚规则见 [[抖音重复度过高的定义]]）
...
- **具体操作**：
  1. 在浏览器中打开 `中间文件/lark-resources/数字人口播脚本发音处理.html`（或将该 HTML 文件保存在浏览器收藏夹中）
...
- **所需工具**：TTS纠错工具（本地 HTML 文件，`中间文件/lark-resources/数字人口播脚本发音处理.html`）
- **预计耗时**：约 1-3 分钟/条
- **负责人**：运营人员
- **向谁汇报**：此步骤无需汇报
...
| **TTS纠错工具** | 脚本发音预处理，确保AI语音正确朗读专业术语 | 本地HTML文件（`中间文件/lark-resources/数字人口播脚本发音处理.html`），浏览器打开即可使用 |
...
| **三人小分队云文档纲要** | 账号体系 / 竞品爆款库（查重基线）/ 自有脚本库 / 运营闭环地图 | [[总结好的大纲以及笔记/实习就业/创业黑马——数智科技部门/工作文件/脚本&推文撰写/脚本资料库/参考的资料/新媒体陪跑/三人小分队云文档纲要]] |
...
## 十、实习期运营数据复盘速览（2026.07.24—09.03，实习已结束）

> [!SUCCESS] 📈 本 SOP 六周实跑的量化结果
> 本 SOP 各环节在实习期（2026-07-24 至 2026-09-03）的实际执行成果，完整分析见 [[总结好的大纲以及笔记/实习就业/创业黑马——数智科技部门/账号数据分析/实习账号运营数据复盘（2026.07.24-09.03）.md|实习账号运营数据复盘（2026.07.24-09.03）]]：
>
> - **产出量**：4 账号累计发布作品 **169 条**（视频 93 / 图文 76），日均 4 条；独立创作脚本 **160+ 条**，对应「每日工作量基准」（4 视频 + 6 图文 + 10 脚本）全程达标不断更；
> - **流量数据**：累计播放 **42.7 万**、互动 **1.37 万**（互动率 3.2%）、主页访问 3,716、作品带来粉丝 **+583**；单条最佳 **5.4 万播放**（长图文），主责双账号（科研华哥 + 发论文的华哥）合计播放 13.7 万；
> - **工时量化**：视频全流程中值 ≈70 min/条 × 93 条 ≈ **108h**；图文 ≈45 min/篇 × 76 篇 ≈ **57h**；**制作总工时 ≈165 小时**（折合每个工作日约 5.5 小时纯制作，不含运营与线索处理）；
> - **获客数据**：灯塔录入有效线索**累计 33 条**、单日峰值 6 条（07.30，含 2 条高意向）、单周峰值 13 条（08.03—08.10）；日均处理评论/私信 20-50 条次，累计 1,000+ 条次；
> - **验证结论**：① 线索量与当日曝光强相关（流量谷→线索 0），矩阵日更是获客保障；② 长图文可出爆款且成本仅为视频 1/2；③ 「脚本 8 分、剪辑 2 分」得到数据验证；④ 限流事件（内容重复）催生「先查重再动笔」红线，8 月后零处罚。

---

## 十一、飞书群运营规范补充（2026-09-09 整理）

> [!INFO] 📌 来源说明
> 本章整理自「三人小分队」飞书群 **2026-07-27 至 2026-08-28** 的运营指令、话术沉淀与共享文档，是对主流程（二/三/四/五章）与注意事项（八章）的**增量补充**；与既有条目冲突时以本章为准（更新时间更晚）。数据复盘佐证见 [[总结好的大纲以及笔记/实习就业/创业黑马——数智科技部门/账号数据分析/实习账号运营数据复盘（2026.07.24-09.03）.md|实习账号运营数据复盘（2026.07.24-09.03）]]。

### 11.1 公众号文章 → 口播展示网页 SOP（2026-07-28）

**用途**：把公众号长文改造成可入镜口播的**单文件 HTML 展示页**（配合口播录制/视频演示/转化页）。核心三件事：**提炼主线 → 改写用户视角文案 → 输出单文件 HTML**。

**输入四要素**：

| 要素 | 说明 |
|------|------|
| A 原始文章 | Markdown / Word / 纯文本均可 |
| B 目标受众 | 必须说清"页面给谁看"（如：想发 SCI 的医学 AI 学生）——同一篇文章对不同人，网页文案完全不同 |
| C 页面用途 | 明确不是普通图文页，而是口播展示/视频录制辅助/演示稿或转化页 |
| D 风格参考 | 给截图或描述：简洁学术风、留白多、黑色描边圆角卡片、白底/米白底、不花哨不强营销感、适合右下角叠加真人口播画面 |

**跟大模型沟通的 5 个关键指令**：
1. **先提炼，不要先写网页**——先提炼成 4-6 个展示模块，不机械搬运原文，结构适合用户阅读和口播；
2. **明确"受众视角"**——如"这个网页面向想发论文的医学 AI 学生"，<span style="color:#e74c3c">禁止出现"根据你给的文章""我帮你整理"等幕后描述</span>（否则会写出"基于你提供的内容"这类穿帮句）；
3. **明确"口播展示稿"属性**——段落短、标题明显、有总结句/金句/结构卡片、版式方便讲述和镜头展示；
4. **明确 HTML 输出格式**——单文件 HTML、CSS 内嵌、本地打开即用、桌面端和手机端都适配（方便同事直接拿走）；
5. **明确边界禁区**——不保留原公众号其他品牌名、不要"扫码领取/免费资料福利"、不把原文全塞进去、不写成营销海报。

**推荐两轮工作流**（比一次到位稳定）：第一轮只做内容重组（提炼主线/重写标题/受众视角结构）；第二轮结构满意后再生成 HTML+CSS 并补口播展示感。

### 11.2 抖音长图文排版规范（2026-08-14）

- **手机端**：段落短、大量换行；
- **重要句子加粗**；
- **BGM**：选热门金曲第三个，音量 **42**；
- **评论区自评**：自己评论一句"领资料"的话术，或把抖音公开群放评论区——两个动作目的相同：**让评论区有回复**（互动撬动流量）；
- 看到好的长文，把账号或链接发到日报里或群里共享（ collectively 沉淀对标库）。

### 11.3 avatarv4 内部自动剪辑工具（8 月中下旬上线）

**背景**：Heygen / MiniMax API 欠费后的替代方案——公司内部「超级数字人智能体 PRO」（**公司以太网环境**访问 `http://172.16.10.27:8501`）。

**核心流程（a-g）**：填标题 → 粘贴文案 → AI 生成四字标题 / 十二字概要 / 关键词 → 上传视频素材 → **勾选"本地音频""有原声"（有原声必须勾）** → 选择剪辑路径（默认 剪辑/齐鲁/鱼哥）→ 排队生成；`MyStatus` 页查看生成状态。

**字幕设置**：标准描边，字体 `WenYue-XinQingNianTi-NC-W5`。使用文档见群共享《avatarv4使用.pdf》。

### 11.4 日报 / 周报双制度（2026-08-07 起执行）

**日报**（每天 **18:00 前**群内回复，老板每天看；周末数据也要计入）：

```text
雷布斯，X月X日今日工作同步：

谢积昌：发布X条视频，X篇图文；今日灯塔录入主动咨询线索X条，截至目前累计线索X条；截至目前总GMV X元。
朱柏达：……（同格式）
创新想法：
```

要点：① 图文数据过 4000 / 视频超 3000 播放的，把链接放日报；② 有好长文也把账号/链接附上；③ GMV 实习期恒为 **0 元**（未成交）。

**周报**（按周汇总，模板实例如 6.1—6.7）：

```text
时间：X月X日-X月X日
一、账号数据
1、【科研华哥】科研华哥，更新X条视频，线索34条（主动留咨16条，筛选线索18条）。审核金1个，转化成交0单
2、【搞科研的华哥】更新17条视频，7篇图文。总播放量7w（较前7日+4.31万)，主动留咨2条线索。
二、问题&解决方案：
（如：小号高频多形式更新后数据上升但仍无破万视频 → 保持更新频率，尝试使用新号）
三、本周工作目标：
a) 日更6-8条内容，至少一条视频热度1w+，评论数翻倍，粉丝群新增30人，主动留资10个；
b) 保持对不同形式内容的尝试（图文、抖音热门）；
c) 脚本主题强聚焦热门选题（消融、特征、频域）。
```

> 💡 注意周报线索口径分两类：**主动留咨**（用户主动留联系方式）与**筛选线索**（互动后筛出），与日报"今日/累计"两级口径并存。

### 11.5 线索筛选三要素与「加急」标记（2026-07-30/31）

- **私信筛选三要素**：**微信号、研究方向、目标区位**。问法实例："宝子你什么研究方向的？研几？""你目标区位是？预计发在哪里？"——这三项都回答了才录入灯塔；
- **加急标记（mentor 约定）**：用户上来就说"华哥，咨询论文 / 论文辅导"这类**主动明确**的话 → 在灯塔研究方向栏加注"**加急**"，mentor 一看即懂——这是**最精准、转化可能最高**的线索；
- **进群 = 变相涨粉**：资料文件大，统一引导"点我主页进公开群领取"——进群必须先关注账号，等于涨粉 + 私域沉淀；
- **线索分配提醒格式**（mentor 群内同步销售跟进状态）：

```text
姓名：X（昵称）
研究方向：X
备注：X（年级/目标，如"准大四准备保研，提前开始弄毕设"）
微信号：X
手机号：暂未填写
分配人：韩玲
...
处理规则：多次添加好友不通过 → 实习生**抖音私信提醒**用户通过；用户要给销售的微信前，**先和 mentor 同步**，配合推进。

### 11.6 私信开场白 A/B 与身份补报（2026-07-29—08-03）

mentor 定稿两版开场白（要求统一使用）：

- **版本 1（资料钩子长版）**："哈喽呀，我是华哥。因为🫘有限制，需要资料的话，点我主页进公开群，资料在群里海报上喔。我们是专门做 ai+科研论文辅导的机构，叫图灵学术，是上市公司。师资覆盖 1000+ 学者，最近半年 170+ 学生成功中稿。方便的话，可以留下你的【研究方向】和【留个\/信】，我加你，咱们细聊。"
- **版本 2（短版）**："我们是专门做论文辅导的机构，叫图灵学术，是上市公司。如果您想辅导论文的话，可以发个\/，还有读的专业，我专门联系您。如果想领取资料的话，因为文件比较大，可以看我主页，进群领取哈。"

**一线实测反馈**（内容岗直接触达用户的证据）：长版也不容易留微信；<span style="color:#e74c3c">提到"论文辅导"部分用户直接不回</span>；半夜积极要资料的多为资料粉——印证"利他资料话术 > 营销话术"。

**身份补报规则**：拿到电话/微信后，**必须补一句身份介绍**（"我们是专门做论文辅导的机构，叫图灵学术，是上市公司……"），否则销售后续添加好友有阻力；建议**先加微信，再铺开**问研究方向/硕博阶段/记灯塔标签。参考流程：获取微信 → 首句身份介绍 → 询问研究方向 → 判断硕博阶段 → 记录灯塔标签。

### 11.7 脚本管理规范（2026-08-03 起）

- 8 月起脚本统一写在 **mentor 的飞书文档链接**里（用她的 AI 额度，也便于她统一查看修改），链接在群置顶公告；
- **生成/使用了哪个脚本，必须在文档里标注"已使用"**——避免两人重复用同一脚本；
- mentor 下发脚本常带**统一口令（黄金结构模板）**："我是华哥，最近半年我们服务了超过 170 个学员中稿" + 采用「痛点指出 + 专家身份 + 三步走干货 + 学员案例 + 引导」的黄金结构 + 资料钩子二选一（【2026 科研能力进阶秘籍】/【能发顶会顶刊的论文缝合大法】）+ 要求"前文讲的内容一定要和后面的资料融合，不要不搭噶"。

### 11.8 大号激活：洗稿策略与结尾钩子轻量化（2026-08-26—28）

- **背景**：大号「科研华哥」播放与粉丝"纹丝不动"（曾是扛把子号），mentor 公开征求激活方案；
- **我方提案（被采纳）**：**直接洗稿近一周的爆款**——拿近一周的爆款内容、尽量不改动太多直接翻拍；不限科研博主，其他行业爆款逻辑可迁移；参考的爆款与脚本要在爆款脚本文档**登记备注**（团队可复用）；
- **执行要点**：要抄就尽可能一样形态（同款形式）；大字报仅一页纸，不适用洗稿策略；
- **结尾钩子轻量化（mentor 纠偏）**："结尾别太重，这是抖音平台，就是互动钩子轻一点"——洗稿稿结尾清一色"这条路我陪 170 人走过"式长抒情（"晋江小作文"），被要求全部改掉；可用豆包从播放逻辑优化结尾。

### 11.9 数字人 TTS 补充规范（2026-08-26/28）

- **英文读法**：脚本里的英文**只读英文**，中文注释仅放字幕——禁止"又读英文又读中文"；
- **年份读法**："2026 年"要读"二〇二六年"，不能是"2000 零 26"——文案必须**先过 TTS 纠错网页 → 再语音 → 再生成视频**；
- **发音修复**：MiniMax 语音发现读错 → 直接改成**谐音字**重新生成；
- **纠错词典共享**：纠错网页预加载词典各人机器不同，mentor 将自己电脑加载的模块**导出分发**，统一团队词典（对应 `tts-corrections` json 的持续维护）；
- **数字人形象**：8.17 / 8.26 上传新形象（黑色短袖、背景干净），优先用新形象；外部剪辑反馈"数字人视频质量下降"时，优先排查以上发音问题。

### 11.10 配图信任杠杆（2026-08-03）

- 每条视频放 **3-4 张配图**提升可信度，来源三类：Google 图片 / 公众号配图 / **已发表论文图片**；
- 8.27 起发放专用素材 mp4（尾帧/喜报/缝合大法/科研能力进阶秘籍），要求**人设部分和结尾钩子部分都放**；并可"用素材倒推脚本内容"（先有素材再设计脚本）。

### 11.11 知识类口播形式参考（2026-08-13）

对标两种已跑通的知识口播形态：
- **纯 PPT 大字报**：参考"水木大师兄"；
- **画板讲解**：参考"清华白也"（excalidraw 手绘画板）；
配套三件套动作：**更新日报 / 找爆款 / 置顶介绍**（主页简介突出业务范围：CS/AI 硕博论文辅导，大模型/CV/NLP/强化学习/AI 交叉）。

### 11.12 其他运营细则汇总

| 事项 | 规范 | 日期 |
|------|------|------|
| **日更基准迭代** | 7.30 起"需要能覆盖账号每天更新"；8.06 明确一个账号 2 条；8.17 周一集中发布每人 4 条视频；8.18 定稿**一人 3 个视频/天**（3 个 2 分钟口播 ≈ 2 小时剪辑） | 07.30—08.18 |
| **图文定位** | 图文只带来播放量、咨询非常少，<span style="color:#e74c3c">线索主要来自视频</span>（视频有信任度）——产能向视频倾斜 | 08.18 |
| **外部剪辑退掉** | 外部剪辑极不稳定（近 2 周总共不到 10 条），老板拍板退掉、回归内部自剪 | 08.18 |
| **爆款整理节奏** | 找**不同选题**的爆款（研一搞科研 → CV 论文写法 → …），避免同质化；一周 10 条即可：一周 2 次×5 条或一次 10 条集中弄 | 08.18 |
| **养号动作** | 刷账号、看抖音、回复评论和私信，**模拟真实用户** | 08.18 |
| **语气规范** | 口播/脚本**不说"您"**——老板觉得拉低 IP 光环 | 08.17 |
| **封面规范迭代** | 老板曾要求统一用剪印模板封面（08.03）→ 实测老封面数据显著更差 → 08.06 允许用自己新做的封面 | 08.03—08.06 |
| **生成视频外发** | 给外部剪辑的视频按"4 个生成视频 + 1 个脚本文档"压缩发 mentor **微信**（外部剪辑走微信不走飞书） | 07.29 |
| **一鱼两吃** | 同一脚本两用：发长文 → 修改后发视频（08.04 首个审核金线索即由此产生） | 08.04 |
| **转正标准** | **每月 60-80 个线索 + 转化 5 万元**启动转正（团队拉齐标准）；经验值"基本上每 2 个审核金就会成交 1 单" | 08.18 |
| **AI 知识沉淀** | mentor 要求"你们看完让 AI 也看下、读取学习"——群指令与文档同步喂给 AI，沉淀为可复用知识库 | 07.30 |
...
- [[总结好的大纲以及笔记/实习就业/创业黑马——数智科技部门/账号数据分析/实习账号运营数据复盘（2026.07.24-09.03）.md|实习账号运营数据复盘（2026.07.24-09.03）]] — 本 SOP 六周实跑的量化复盘（产出/流量/线索/工时）
...
- [[中间文件/lark-resources/数字人口播脚本发音处理.html]] — TTS纠错工具（发音预处理）
- [[总结好的大纲以及笔记/实习就业/创业黑马——数智科技部门/工作文件/脚本&推文撰写/脚本资料库/参考的资料/受众报告/受众报告]] — 受众报告（矩阵账号方向规划：画像/痛点/内容线/调整清单/执行节奏）
- [[总结好的大纲以及笔记/实习就业/创业黑马——数智科技部门/工作文件/脚本&推文撰写/脚本资料库/参考的资料/新媒体陪跑/三人小分队云文档纲要]] — 三人小分队云文档纲要（账号体系/竞品库/自有脚本库/查重基线）
